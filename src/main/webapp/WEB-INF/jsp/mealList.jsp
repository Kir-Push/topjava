...
<section>
    ...
    <form class="form-horizontal" method="post"  id="filterRows">
        <dl>
            <dt>From Date:</dt>
    ...
    <table class="table table-striped display" id="datatable">
        ...
        <c:forEach items="${mealList}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}" id=${meal.id}>
                ...
                <td>${meal.calories}</td>
                <td><a class="btn btn-xs btn-primary update"  description="${meal.description}" dateTime="${meal.dateTime}" calories="${meal.calories}">Update</a></td>
